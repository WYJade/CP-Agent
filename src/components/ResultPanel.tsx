...
export default function ResultPanel({ results, quickActions, onQuickAction, onSaveAsCase }: ResultPanelProps) {
  ...
  return (
    <div className="w-[300px] border-l border-[#2a2a3e] bg-[#12121f] flex flex-col flex-shrink-0">
      ...
      <div className="h-11 border-b border-[#2a2a3e] flex items-center px-4 flex-shrink-0">
        ...
        {results.length > 0 && onSaveAsCase && (
          <button
            onClick={onSaveAsCase}
            className="ml-auto flex items-center gap-1 px-2 py-1 text-[10px] text-purple-400 hover:bg-purple-600/10 rounded transition-colors border border-purple-500/20"
          >
