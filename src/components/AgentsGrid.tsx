      ...
      <div className="max-w-6xl mx-auto px-10 py-10">
        ...
        <div className="space-y-8">
          {rows.map((row, idx) => (
            <section key={idx}>
              {/* Section Title */}
              <h2 className="text-xs font-medium text-gray-500 mb-3">{row.title}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-px bg-[#1e1e32] border border-[#1e1e32] rounded-lg overflow-hidden">
                {row.agents.map((agent) => (
                  ...
                  >
                    ...
                    {/* Description */}
                    <p className="text-[11px] text-gray-500 leading-relaxed line-clamp-3 group-hover:text-gray-400 transition-colors pl-[42px]">
                      {agent.description}
                    </p>
                  </button>
                ))}
