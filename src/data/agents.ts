...
export const agentCategories: AgentCategory[] = [
  {
    ...
    agents: [
      ...
      },
      {
        id: "quote-agent",
        name: "Quote Agent",
        description: "Handles quote requests, comparisons, and approval workflows.",
        welcomeMessage: "Welcome! I am your Quote Agent. I can help you request quotes, compare pricing, and manage approval workflows.",
        suggestedQuestions: [
          "Compare latest quotes for raw materials",
          "What quotes are expiring this week?",
          "Show quote-to-PO conversion rate",
        ],
        quickActions: [
          ...
          { label: "Price trend forecast", icon: "forecast", color: "purple" },
    ...
    agents: [
      {
        ...
        quickActions: [
          { label: "Arrival schedule", icon: "chart", color: "purple" },
          { label: "Delayed shipments", icon: "warning", color: "yellow" },
          { label: "Dock utilization", icon: "table", color: "blue" },
          { label: "Receiving report", icon: "report", color: "green" },
          { label: "Arrival forecast", icon: "forecast", color: "purple" },
          { label: "Optimize dock slots", icon: "optimize", color: "orange" },
        ],
      },
    ],
  },
